...
class CrawlThread(threading.Thread):
    ...
    def scheduler(self):
        while not self.queue.empty():
            ...
            url = f'https://www.zhihu.com/question/437643484'
...
class ParserThread(threading.Thread):
    ...
    def parse_data(self, item):
        ...
        try:
            ...
            for book in books:
                try:
                    title = book.xpath('//div[@class="List-item"]//a[@class="UserLink-link"]/text()')
                    link = book.xpath('//div[@class="List-item"]//div[@class="RichContent-inner"]/span[1]/p/text()')
                    response = {
                        'title': title,
                        'link': link
                    }
